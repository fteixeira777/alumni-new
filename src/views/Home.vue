  ...
  <div class="container-fluid">
    ...
    <div class="row align-items-start">
      ...
      <div class="col col-12">
        <div class="countdown">
          <div class="col-12">
              <form @submit.prevent="storeSubscriber" ref="register">
              <div class="form-group">
                  <div class="form">
                      <h3 style="padding-bottom:20px">Faz a tua pré-inscrição</h3>

                      <h6 style="padding-bottom:20px">
                        Pedimos desculpa por qualquer incómodo mas por motivos logísticos 
                        já não é possível reservar camisola para o evento nem reservar lugar para as atividades (kart / lasergame).
                      </h6>
                      <div>
                      ...
                      <div style="padding-top:15px" v-if="false">
                      ...
                      <h3 style="padding-top:30px;padding-bottom:20px" v-if="false">Atividades</h3>
                      <div v-if="false">
